...
## we need this to create tenure bins
df_1=pd.read_csv("telecom_clean.csv")
...
def predict():
    ...
    single = churn_model.predict(new_df__dummies.tail(1))
    probablity = churn_model.predict_proba(new_df__dummies.tail(1))[:,1]
